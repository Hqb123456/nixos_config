...
(let* ((bg "#171212")
      ...
      (on-primary "#512224")
      (on-primary-container "#3e1316")
      (on-secondary "#422a2a")
      (on-secondary-container "#d5afaf")
      (on-surface "#ece0df")
      (on-surface-variant "#d7c2c1")
      (on-tertiary "#3f2e00")
      (on-tertiary-container "#2c1f00")
      (outline-color "#9f8c8c")
      (outline-variant "#524343")
      (primary "#feb3b4")
      (primary-container "#c17f80")
      (secondary "#e4bdbd")
      (secondary-container "#5e4242")
      (shadow "#000000")
      (surface "#171212")
      ...
      (tertiary "#e2c37e")
      (tertiary-container "#a98d4e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#e2c37e")
      (on-success "#3f2e00")
      (success-container "#a98d4e")
      (on-success-container "#2c1f00")
      ;; Map fixed colors to regular colors
      (primary-fixed "#feb3b4")
      (primary-fixed-dim "#c17f80")
      (secondary-fixed "#e4bdbd")
      (secondary-fixed-dim "#5e4242")
      (tertiary-fixed "#e2c37e")
      (tertiary-fixed-dim "#a98d4e")
      (on-primary-fixed "#512224")
      (on-primary-fixed-variant "#3e1316")
      (on-secondary-fixed "#422a2a")
      (on-secondary-fixed-variant "#d5afaf")
      (on-tertiary-fixed "#3f2e00")
      (on-tertiary-fixed-variant "#2c1f00")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ece0df")
      (inverse-primary "#feb3b4")
      (inverse-surface "#171212")
